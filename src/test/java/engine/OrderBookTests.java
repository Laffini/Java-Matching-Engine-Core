...
public class OrderBookTests extends MatchingEngineTest {
    ...
    final Order[] orders = { new Order(3, 2, "buyOrder", Side.BUY), new Order(3, 2, "sellOrder", Side.SELL) };
    ...
    public void buyThenSell() {
        ...
        final OrderBook orderBook = new OrderBook(new ArrayList<Order>(), new ArrayList<Order>());
        ...
        assertEquals(trade.getPrice(), 2);
        assertEquals(trade.getAmount(), 3);
